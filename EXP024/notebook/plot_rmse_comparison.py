# %% [markdown]
# # EXP024 RMSE comparison
#
# `item_bank_uncor_1.csv` 上の MFI、EXP020、EXP023、EXP024を比較する。
...
def find_project_root() -> Path:
    ...
    for root in [cwd, *cwd.parents]:
        if (root / "data").is_dir() and (root / "EXP024").is_dir():
            return root
...
figure.tight_layout()
EXP024_RESULTS.mkdir(parents=True, exist_ok=True)
output_path = (
    EXP024_RESULTS / f"rmse_comparison_uncor_{BANK_ID}_gamma_{GAMMA}_seed_{SEED}.png"
)
