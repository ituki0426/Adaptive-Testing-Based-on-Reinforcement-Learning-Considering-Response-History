...
# Generate uncorrelated 3PL item banks for the simulation study, following the
# settings of Wang, Liu & Xu (2024):
#   a ~ N(1.2, 0.25), b ~ N(0, 1), c ~ N(0.25, 0.02)
# Ten banks of 500 items each are written to data/3PL.
#
...
OUTPUT_DIR <- file.path(root_dir, "data", "3PL")
...
message(sprintf("Wrote %d 3PL banks to: %s", BANK_COUNT, OUTPUT_DIR))
