...
output_dir   <- get_env("OUTPUT_DIR", file.path(root_dir, "data", "3PL", "results"))

bank_dir       <- file.path(root_dir, "data", "3PL")
...
records_path <- file.path(results_dir, sprintf("records_3pl_%d_MFI%s.csv", bank_id, output_suffix))
summary_path <- file.path(results_dir, sprintf("summary_3pl_%d_MFI%s.csv", bank_id, output_suffix))
