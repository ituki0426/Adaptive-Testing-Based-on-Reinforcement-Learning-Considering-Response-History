...
required_packages <- c("ShinyItemAnalysis", "mirt")
...
output_dir <- "data/real_responses_ShinyItemAnalysis_dataMedical"
train_ratio <- 0.8
...
responses <- as.data.frame(ShinyItemAnalysis::dataMedical[, 1:100])
