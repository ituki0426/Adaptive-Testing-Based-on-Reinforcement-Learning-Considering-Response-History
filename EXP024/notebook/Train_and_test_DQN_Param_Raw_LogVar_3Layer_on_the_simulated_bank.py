# %% [markdown]
# # EXP024: DQN-Param-Raw + Log Posterior Variance + 3 Hidden Layers
#
# EXP023 に対して、状態へ log posterior variance を追加し、
# 64ユニットの隠れ層を1層追加する。
#
...
EXP024_DIR = ROOT / "EXP024"
MODEL_DIR = EXP024_DIR / "models"
RESULTS_DIR = EXP024_DIR / "results"
...
stem = (
    f"uncor_{cfg.bank_id}_DQN_Param_Raw_LogVar_3Layer_"
    f"{cfg.prior}_gamma_{cfg.gamma}_seed_{cfg.seed}"
)
model_path = MODEL_DIR / (
    f"dqn_param_raw_logvar_3layer_{cfg.prior}_uncor_{cfg.bank_id}_"
